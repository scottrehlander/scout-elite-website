...
## Hidden games arcade (/arcade/) — 2026-08-12
...
- The games: Keep It In (blue-line pinch timing), Breakaway, Shootout (goalie learns your shot tendencies across visits), Coach's Challenge (frame-scrub offside calls), The Telestrator (draw a route, players run it literally), Zamboni (ice-slide resurfacing puzzle), Rink Crossword (daily criss-cross puzzle generated from `_data/hockey_glossary.json`, deterministic per local date).
