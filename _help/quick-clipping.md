---
layout: kb-article
title: "Quick Clipping: Mark Moments as You Watch"
description: "Use Scout Elite's Quick Clip strip to mark game moments in one tap or a few keystrokes: tag buttons, keyboard shortcuts, capture windows, Focus mode, and triage."
permalink: /help/quick-clipping/
...
Open a video in a [Clip Project](/help/creating-clip-projects/) on a desktop or tablet and your tags appear as a row of buttons floating over the bottom of the video. Each button is a tag from your enabled [Tag Libraries](/help/tag-libraries/), colored by section so related tags read at a glance.
...
3. When the queue is empty, your clip list is clean and ready for [Reviews](/help/creating-reviews/)
...
<div class="kb-related">
  ...
  <ul>
    <li><a href="/help/tag-libraries/">Setting Up Tag Libraries</a></li>
