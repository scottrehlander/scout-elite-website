...
description: Save hours on video review with Scout Elite's live game clipping and automated analysis tools. Built by coaches, for youth hockey teams. Start your free trial today.
...
<section class="hero" style="background: var(--primary-bg); padding: 80px 0 64px 0;">
    <div class="container">
        <div class="hero-content" style="max-width: 640px; margin: 0 auto; text-align: center;">
            <h1 class="hero-title" style="font-size: 3rem; line-height: 1.1; margin-bottom: 1.5rem;">Stop Spending Hours on Video Review. Start Coaching Smarter.</h1>
            <p class="hero-subtitle" style="font-size: 1.25rem; margin-bottom: 2rem; color: var(--text-secondary);">Scout Elite saves coaches 5+ hours per week with live game clipping and automated video analysis. Built by parent coaches who understand your challenges.</p>
    ...
    <div class="container">
        ...
        <div style="display: grid; gap: 3rem; max-width: 1000px; margin: 0 auto;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
                ...
                <div style="background: var(--card-bg); padding: 3rem; border-radius: 1rem; text-align: center;">
            ...
            <!-- Step 2 -->
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
                <div style="background: var(--card-bg); padding: 3rem; border-radius: 1rem; text-align: center; order: 1;">
                    <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p style="margin-top: 1rem; font-weight: 600;">Automatic Clip Creation</p>
                </div>
                <div style="order: 2;">
                    ...
                    <h3 style="font-size: 1.75rem; margin-bottom: 1rem;">Upload Video, Get Instant Clips</h3>
                    <p style="font-size: 1.1rem; color: var(--text-secondary); margin-bottom: 1.5rem;">Upload your game footage. Scout Elite automatically generates clips from your tagged moments. Whether you tracked live or clipped afterward. What used to take 3+ hours now takes 5 minutes.</p>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
                        <li style="margin-bottom: 0.75rem;">✓ Automatic clip generation from your tags</li>
                        <li style="margin-bottom: 0.75rem;">✓ Smart buffering captures full context</li>
                        <li style="margin-bottom: 0.75rem;">✓ Organize clips by player, situation, or skill</li>
                    </ul>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
                <div>
                    ...
                    <h3 style="font-size: 1.75rem; margin-bottom: 1rem;">Share Targeted Reviews</h3>
                    <p style="font-size: 1.1rem; color: var(--text-secondary); margin-bottom: 1.5rem;">Create position-specific or player-specific review sessions. Defensemen only see defensive clips. Goalies get goalie-focused feedback. Keep sessions short, relevant, and engaging.</p>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
