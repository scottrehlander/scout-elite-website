    ...
    <div class="container">
        <div class="hero-content" style="max-width: 640px; margin: 0 auto; text-align: center;">
            ...
            <div class="hero-cta" style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="https://xpress.scout-elite.com/account/register?plan=pro&utm_source=scout-elite&utm_medium=website&utm_campaign=landing-coach&utm_content=cta" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2rem;">Start Free 14-Day Trial</a>
        ...
        <div style="display: grid; gap: 3rem; max-width: 1000px; margin: 0 auto;">
            ...
            <div class="step-container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
                <div>
                    ...
                    <p style="font-size: 1.1rem; color: var(--text-secondary); margin-bottom: 1.5rem;">Keep it broad or create position-specific Reviews. With targeted Reviews, defensemen only see defensive clips. Goalies get goalie-focused feedback. You can keep them short, relevant, and engaging.</p>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
                ...
                <div class="step-visual" style="background: var(--card-bg); padding: 3rem; border-radius: 1rem; text-align: center;">
                    ...
                    <p style="margin-top: 1rem; font-weight: 600;">Targeted Review</p>
                </div>
            </div>
        </div>

        <div style="text-align: center; margin-top: 4rem;">
            <a href="https://xpress.scout-elite.com/account/register?plan=pro&utm_source=scout-elite&utm_medium=website&utm_campaign=landing-coach&utm_content=cta" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem;">Start Your Free Trial</a>
        </div>
    </div>
</section>
...
<section id="pricing" style="background: var(--secondary-bg); padding: 64px 0;">
    <div class="container" style="max-width: 800px;">
        ...
        <div style="background: var(--card-bg); border-radius: 1rem; padding: 3rem; text-align: center; box-shadow: 0 4px 24px rgba(0,0,0,0.1);">
            ...
            <a href="https://xpress.scout-elite.com/account/register?plan=pro&utm_source=scout-elite&utm_medium=website&utm_campaign=landing-coach&utm_content=cta" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem; width: 100%; max-width: 400px; display: inline-block;">Start Your Free Trial</a>
            
            <p style="margin-top: 1.5rem; font-size: 0.9rem; color: var(--text-secondary);">Need Solo accounts for your team? Solo plan available for $4.99/month</p>
        </div>
    </div>
</section>
    ...
    <div class="container" style="max-width: 800px;">
        ...
        <div style="display: grid; gap: 1.5rem;">
            ...
            <div style="background: var(--card-bg); padding: 2rem; border-radius: 0.75rem;">
                ...
                <p style="color: var(--text-secondary);">Pro plan includes priority support from our team (built by coaches, for coaches). We'll help you get set up and answer any questions.</p>
            </div>
...
<section style="background: var(--accent-color); background: linear-gradient(135deg, var(--accent-color) 0%, var(--accent-hover) 100%); color: white; padding: 80px 0;">
    <div class="container" style="max-width: 800px; text-align: center;">
        ...
        <a href="https://xpress.scout-elite.com/account/register?plan=pro&utm_source=scout-elite&utm_medium=website&utm_campaign=landing-coach&utm_content=cta" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem;">Start Free 14-Day Trial</a>
