    ...
    <div class="container">
        <div class="hero-content" style="max-width: 640px; margin: 0 auto; text-align: center;">
            ...
            <div class="hero-cta" style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                <a href="https://xpress.scout-elite.com/account/register?plan=solo" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2rem;">Start Organizing for Free</a>
...
<section id="how-it-works" style="background: var(--primary-bg); padding: 64px 0;">
    <div class="container">
        ...
        <div style="text-align: center; margin-top: 4rem;">
            <a href="https://xpress.scout-elite.com/account/register?plan=solo" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem;">Start Your Free 14-Day Trial</a>
        </div>
    </div>
</section>
...
<section id="pricing" style="background: var(--secondary-bg); padding: 64px 0;">
    <div class="container" style="max-width: 800px;">
        ...
        <div style="background: var(--card-bg); border-radius: 1rem; padding: 3rem; text-align: center; box-shadow: 0 4px 24px rgba(0,0,0,0.1);">
            ...
            <a href="https://xpress.scout-elite.com/account/register?plan=solo" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem; width: 100%; max-width: 400px; display: inline-block;">Start Organizing Your Clips</a>
...
<section style="background: var(--accent-color); background: linear-gradient(135deg, var(--accent-color) 0%, var(--accent-hover) 100%); color: white; padding: 80px 0;">
    <div class="container" style="max-width: 800px; text-align: center;">
        ...
        <a href="https://xpress.scout-elite.com/account/register?plan=solo" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2.5rem;">Start Free 14-Day Trial</a>
