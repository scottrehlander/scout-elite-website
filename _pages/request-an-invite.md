    ...
    <div class="hero-content" style="text-align:center; max-width:600px; margin:0 auto; width:100%;">
      ...
      <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; width:100%;">
        <div class="hero-cta" style="margin-top:2em; text-align:center;">
          <a target="_blank" href="https://xpress.scout-elite.com/account/register?utm_source=scout-elite&utm_medium=website&utm_campaign=request-invite&utm_content=create-account" class="btn btn-primary" style="margin-right:1em; min-width:140px; display:inline-block;">Create an Account</a>
